    ...
    return (
        ...
        <div className="hero-content grid lg:grid-cols-2 md:gap-10 items-center">
          ...
          <div className=' text-center md:text-start'>
            <p className="inline-flex items-center border rounded-full p-1 bg-red-400/30 text-red-500 text-sm md:text-lg font-medium"><GiJusticeStar />Frontier AI Models</p>
            <h1 className="text-2xl lg:text-5xl font-bold leading-tight tracking-tighter  text-red-600">
            One Subscription.
            <br />
          ...
          <p className="text-sm md:text-lg text-zinc-700 max-w-lg">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className="bg-red-600 hover:bg-red-500 transition-all px-4 py-2 rounded-2xl cursor-pointer  font-semibold md:text-lg shadow-xl shadow-red-500/30 flex items-center gap-3 group text-white mx-auto md:mx-0">
